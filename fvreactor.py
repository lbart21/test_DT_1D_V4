...
f.write('# 1:t(s) 2:T(K) 3:p(Pa) 4:rho(kg/m^3) 5:massf_N2 6:massf_N 7:conc_N2 8:conc_N\n')
f.write("%10.3e %10.3f %10.3e %10.3e %20.12e %20.12e %20.12e %20.12e\n" %
        (t, gs.T, gs.p, gs.rho, gs.massf[0], gs.massf[1], gs.conc[0], gs.conc[1]))
while t <= tFinal:
    #print("Printing fluid state props before reactor time stepping")
    #print("rho: ", gs.rho, "p: ", gs.p, \
                #"T: ", gs.T, "massf: ", gs.massf)
    ...
    #print("Printing fluid state props before prop update")
    #print("rho: ", gs.rho, "p: ", gs.p, \
                        #"T: ", gs.T, "massf: ", gs.massf)
    gs.update_thermo_from_rhou()
    #print("Printing fluid state props after prop update")
    #print("rho: ", gs.rho, "p: ", gs.p, \
                        #"T: ", gs.T, "massf: ", gs.massf)
    f.write("%10.3e %10.3f %10.3e %10.3e %20.12e %20.12e %20.12e %20.12e\n" %
    (t, gs.T, gs.p, gs.rho, gs.massf[0], gs.massf[1], gs.conc[0], gs.conc[1]))
